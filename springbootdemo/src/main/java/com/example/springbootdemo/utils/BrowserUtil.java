...
public class BrowserUtil {
	...
	public static boolean isIE8(HttpServletRequest request) {
		return IE8.equals(getBrowserType(request));
	}

	public static boolean isIE678(HttpServletRequest request) {
		String browserType = getBrowserType(request);
		return IE6.equals(browserType) || IE7.equals(browserType) || IE8.equals(browserType);
	}
