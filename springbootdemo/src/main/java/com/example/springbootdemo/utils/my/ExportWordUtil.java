...
public class ExportWordUtil {
    ...
    private static ExportWordUtil service = null;

    private ExportWordUtil() {
        super();
    }

    public static ExportWordUtil getInstance() {
        if(service == null) {
            synchronized(ExportWordUtil.class){
                if(service == null) {
                    service = new ExportWordUtil();
                }
            }
        }
        return service;
    ...
    public static void main(String[] args) {
        ...
        getData(dataMap);
        String templateFile = "C:\\Users\\Alien\\Desktop\\exportTemplate.ftl";
        String exportFile = "C:\\Users\\Alien\\Desktop\\luedf.doc";

        try {
            ExportWordUtil.getInstance().createDocFile(templateFile, dataMap, exportFile, 1);
        } catch (Exception e) {
